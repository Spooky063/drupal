 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_block_alter(array &$suggestions, array $variables) {
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_field_alter(array &$suggestions, array $variables) {
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_views_view_alter(array &$suggestions, array $variables) {
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_container_alter(array &$suggestions, array $variables) {
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_form_element_alter(array &$suggestions, array $variables) {
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_fieldset_alter(array &$suggestions, array $variables) {
  if(isset($variables['element']['#type'])) {
    $new = $variables['theme_hook_original'] . '__' . $variables['element']['#type'];
    if (!in_array($new, $suggestions)) {
      array_splice($suggestions, count($suggestions) + 1, 0, $new);
 ...
 * @inheritdoc
 */
function periscope_theme_suggestions_entity_print_alter(array &$suggestions, array $variables) {
  if(isset($_GET['type'])) {
